...
public class PolymorphismDemo {
	...
	public static void main(String[] args) {
		...
		Month objMonth = new Month(2);
		System.out.println(objMonth.toString());
		
		SchoolMonth objSchoolMonth = new SchoolMonth(12);
		System.out.println(objSchoolMonth.toString());
		System.out.println("Contains Holiday:"+objSchoolMonth.containsHolidays());
